...
public class MySQLSaverV2 extends AbstractMySQLSaverV2 {

    public static class Builder extends AbstractBuilder<Builder> {

        public MySQLSaverV2 build() throws Exception {
            return new MySQLSaverV2(this);
        }
    }
    ...
    protected MySQLSaverV2(Builder builder) throws Exception {
        super(builder);
    }
