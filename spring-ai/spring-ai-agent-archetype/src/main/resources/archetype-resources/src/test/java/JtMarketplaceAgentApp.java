...
//DEPS ${package}:langgraph4j-bom:${version}@pom
//DEPS ${package}:langgraph4j-core
//DEPS ${package}:langgraph4j-javelit
...
//SOURCES ${packageInPathFormat}/spring/ai/agent/AiModel.java
//SOURCES ${packageInPathFormat}/spring/ai/agent/AgentMarketplace.java
//SOURCES ${packageInPathFormat}/spring/ai/agent/AgentPayment.java
