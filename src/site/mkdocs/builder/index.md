...
```bash
docker pull bsorrentino/langgraph4j-builder:1.9.0-beta5
```
...
docker run --rm \
  ...
  -e LANGRAPH4J_GEN=generator-1.9.0-beta5-jar-with-dependencies.jar \
  -e RUNNING_IN_DOCKER=true \
  bsorrentino/langgraph4j-builder:1.9.0-beta5
```
