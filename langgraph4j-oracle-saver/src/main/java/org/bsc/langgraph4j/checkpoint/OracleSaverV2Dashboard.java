...
public class OracleSaverV2Dashboard extends AbstractOracleSaverV2 {

    public static class Builder extends AbstractBuilder<Builder> {

        public OracleSaverV2Dashboard build() throws Exception {
            return new OracleSaverV2Dashboard(this);
        }
    ...
    public OracleSaverV2Dashboard(Builder builder) throws Exception {
        super(builder);
    }
