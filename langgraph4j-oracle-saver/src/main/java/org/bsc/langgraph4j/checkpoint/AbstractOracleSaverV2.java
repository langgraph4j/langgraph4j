...
public abstract class AbstractOracleSaverV2 extends AbstractOracleSaver {

    public static final String THREAD_ROW_ID = "MYSQL_THREAD_ROW_ID";

    protected AbstractOracleSaverV2(AbstractBuilder<?> builder) throws Exception {
        super(builder);
    }
    ...
    @Override
    public Optional<BaseCheckpointSaver.Tag> tag(RunnableConfig config, Integer version) throws Exception {
        ...
        return exec(conn -> {
            ...
            return Optional.of(new BaseCheckpointSaver.Tag(threadId(config), version, checkpoints));
        });
    }
