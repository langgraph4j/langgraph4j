...
public class PromptChainingStubTest {
    ...
    void promptChainStopsWhenTheInitialJokeHasAPunchline() throws Exception {
        var result = workflow().invoke(GraphInput.args(Map.of(JokeState.TOPIC, "pass")),RunnableConfig.empty())
                .orElseThrow();
    ...
    void promptChainImprovesAndPolishesJokesWithoutAPunchline() throws Exception {
        var result = workflow().invoke(GraphInput.args(Map.of(JokeState.TOPIC, "fail")),RunnableConfig.empty())
                .orElseThrow();
