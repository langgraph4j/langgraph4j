...
public class StateGraphRepresentationTest {
    ...
    public void testCompiledGraphToJson() throws Exception {
        ...
        final var jsonString = workflow.compile().toJSON();
    ...
    public void testLangGraphDslSchemaResource() throws Exception {
        ...
        try (var input = StateGraphRepresentationTest.class.getResourceAsStream("/langgraph4j-dsl.schema.json")) {
            assertNotNull(input);
        ...
        final JsonNode json = OBJECT_MAPPER.readTree(workflow.compile().toJSON());
    ...
    public void testCompiledGraphToJsonWithSubgraph() throws Exception {
        ...
        final var jsonString = stateGraph.compile().toJSON();
